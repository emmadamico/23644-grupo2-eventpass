      ...
      <section className="p-0 m-0 hero__text-wrapper d-flex align-items-center">
        <article className="row m-0 p-0 w-100  hero__text-hover text-bigger glass-bg">
          ...
          <div className="col-12 col-lg-2 p-0 m-0 d-flex flex-column justify-content-center">
            ...
            <p className="m-0 p-0  fs-4 text-center text-lg-end text-white animate__animated animate__bounce animate__animated animate__bounce">
              <span className="hero__text-green fst-italic fw-bold textShadow textShadow">
                enjoy{" "}
              </span>{" "}
              the
            </p>
