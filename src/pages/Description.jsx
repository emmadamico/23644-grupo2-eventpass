            ...
            { eventData ? 
                    ( <img src={
                      eventData.images.find(
                        (image) => image.width === 2048 && image.height === 1152)?.url || eventData.images[0].url
                      }
                    className='img-fluid' 
                    alt={eventData.name}/> ) 
                    : 
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 pt-2 mb-3">
                            <h1 className='text-white fw-bold bg-black p-2 px-4 fs-1 mb-5'>{eventData ? (eventData.name) : (`titulo`)}</h1>
                            <a href="" className='btn btn-light'>Ver en Mapa</a>
                        </div>
                        <div className="col-lg-6 mb-3">
                            <div className='bg-light rounded-4 p-5'>
                                <h3>9, 10 y 11 de Noviembre</h3>
                                <p>Estadio River Plate <br /> Av. Pres. Figueroa Alcorta 7597 <br /> CABA</p>
                                <a href="" className='btn btn-dark w-100 rounded rounded-5 py-2'>Comprar Entrada</a>
                            </div>
                        </div>
                    </div>
                </div>
